...
SECRET_KEY = 'django-insecure-tcwp8ct)w0i39r8x-mn4d!klzv+e@^x#roal)^_i4wi^zav9ka'
...
# Inform Django it's behind a proxy and that it should trust the X-Forwarded-Proto header
